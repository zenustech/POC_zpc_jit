...
jit_cu_lib = CLib()
def init_zpc_nvrtc_lib(jit_cu_lib_path : str):
    jit_cu_lib.init_lib(jit_cu_lib_path)
...
jit_llvm_lib = CLib()
def init_zpc_clang_lib(jit_llvm_lib_path : str):
    jit_llvm_lib.init_lib(jit_llvm_lib_path)
